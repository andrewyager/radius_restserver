...
angular.module('frontendApp')
  ...
  .controller('StatsCtrl', function (urls, $http, $scope, $timeout, $q, $state, $filter) {
      ...
      $scope.firstDayLastMonth = new Date(
        $scope.firstDayLastMonth.getFullYear(), 
        $scope.firstDayLastMonth.getMonth() - 1, 1
      );
     ...
     $scope.date_range = {fromdate: '2015-11-7', todate: '2015-11-7'};
        ...
        $scope.period_select_items = [{
            id: 1,
            label: 'Current Month',
            date_range: {fromdate: $scope.firstDayThisMonth, todate: $scope.dateCurrent},
        }, 
        {
            id: 2,
            label: 'Previous Month',
            date_range: {fromdate: $scope.firstDayLastMonth, todate: $scope.firstDayThisMonth},
        },
        {
            id: 3,
            label: 'Last 7 days',
            date_range: {fromdate: $scope.date7DaysAgo, todate: $scope.dateCurrent},
        },
        {
            id: 4,
            label: 'Last day',
            date_range: {fromdate: $scope.dateYesterday, todate: $scope.dateCurrent},
        },
        ];
